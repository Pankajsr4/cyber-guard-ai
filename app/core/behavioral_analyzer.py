...
class BehavioralAnalyzer:
    ...
    def __init__(self):
        ...
        # Keywords for different behavioral patterns
        self.sarcasm_indicators = ['yeah right', 'sure', 'obviously', 'totally']
        self.passive_aggressive_indicators = ['fine', 'whatever', 'if you say so']
        self.manipulation_indicators = ['you always', 'you never', 'everyone thinks']
        self.gaslighting_indicators = ['you\'re crazy', 'that never happened', 'you\'re imagining']
        self.dominance_indicators = ['you must', 'you will', 'do as i say']
        self.hostility_indicators = ['hate', 'stupid', 'idiot', 'shut up']
        self.anxiety_indicators = ['worried', 'scared', 'anxious', 'nervous']
        self.crisis_indicators = ['kill myself', 'end it all', 'can\'t go on', 'suicide']
    ...
    def _detect_pattern(self, content: str, indicators: list) -> float:
        """Detect behavioral pattern based on indicators"""
